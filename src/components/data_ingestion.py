...
class DataIngestion:
    ...
    def export_data_into_feature_store_path(self)-> pd.DataFrame:
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        try:
            feature_store_file_path = self.export_data_into_feature_store_path()

            logging('got the data from mongodb')
